  ...
  return (
    <div className="text-black/75 flex items-center justify-center relative w-full h-full">
      <span className="inline-block border-dashed rounded-full border-4 border-pink-500 p-1 bg-white">
        <span className="h-86 w-86 flex rounded-full bg-gradient-to-br from-purple-500 to-pink-500"></span>
      </span>
      <img
        src="./purplewoman.png"
      ...
      <div className="absolute lg:-left-8 lg:top-42 xl:left-10 xl:top-42 flex items-center gap-4 rounded-lg py-1 px-4 bg-white/70 backdrop-blur-md shadow-[0_2px_20px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex flex-col -space-y-1">
          <h2 className="text-center font-bold text-xl text-purple-500">50+</h2>
          <p>Online Courses</p>
        </div>
      </div>
      ...
      <div className="absolute lg:left-2 xl:left-20 bottom-20 flex flex-col items-center gap-3 rounded-lg py-3 px-4 bg-white/70 backdrop-blur-md shadow-[0_2px_20px_rgba(0,0,0,0.5)]">
        ...
        <button className="ml-7 text-sm bg-purple-500 text-white py-2 px-4 rounded-sm transition-colors hover:bg-purple-600">
          Join now
        </button>
      </div>
    </div>
