export default function Subscribe() {
  return (
    <section className="w-full max-[460px]:h-[35vh] min-[460px]:max-sm:h-[40vh] h-[60vh] bg-white flex items-center justify-center rounded-tl-[6em] rounded-br-[6em] sm:rounded-tl-[8em] sm:rounded-br-[8em] max-sm:text-xs">
      <div className="w-full max-[460px]:scale-70 min-[460px]:max-[924px]:scale-90 py-6 sm:py-8 xl:px-36 rounded-4xl sm:rounded-3xl bg-gradient-to-br from-purple-500 to-pink-500 text-center flex flex-col items-center">
