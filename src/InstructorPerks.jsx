  ...
  return (
    <section className="sm:h-screen sm:grid sm:grid-cols-2 flex flex-col py-10 px-6 sm:px-0 sm:py-0 text-black/80">
      <div className="flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col gap-2 sm:w-[29em]">
        ...
        <div className="flex flex-col gap-2 sm:pl-8">
          <h2 className="sm:text-3xl text-xl font-semibold">Enjoy Many Perks</h2>
          <Perks />
        </div>
        <span className="max-sm:self-start sm:pr-66">
